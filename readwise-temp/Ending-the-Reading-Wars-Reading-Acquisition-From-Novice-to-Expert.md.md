...
![rw-book-cover](https://readwise-assets.s3.amazonaws.com/media/reader/parsed_document_assets/289035065/LJtTRkj01_1jWomKwKeZ_N7KpSnVEiXqql8-Ltk6iJU-cove_FbuxrF5.png)
...
## Highlights
- The first limitation is that, although there have been many reviews describing the strength of the evi- dence for phonics instruction (e.g., Rose, 2006), it is more difficult to find an accessible tutorial review explaining why phonics works. ([View Highlight](https://read.readwise.io/read/01jqw843mefhwhg0aerb7r35nt))
- Therefore, it is important to understand how children progress to this more advanced form of word recognition and how teaching practice can support this. In addition, reading comprehension clearly entails more than the identification of individual words: Children are not literate if they cannot understand text. ([View Highlight](https://read.readwise.io/read/01jqw87fwfpb167tmq2xws1004))
- That is, instead of showing how a foundation of phonic knowledge permits a child to understand and gain experience with text, this imbalance has allowed a characterization of phonics as “barking at print” (read- ing aloud robotically without understanding) to con- tinue among educationalists (e.g., Davis, 2013; Samuels, 2007) and public figures (e.g., Rosen, 2012). ([View Highlight](https://read.readwise.io/read/01jqw88dx9013x42r60ex0qwee))
- If a child is exposed to a rich spoken-language environ- ment, that child will almost certainly learn to under- stand and produce spoken language. ([View Highlight](https://read.readwise.io/read/01jqw8j74zhxkr1rwapnj8j3ap))
